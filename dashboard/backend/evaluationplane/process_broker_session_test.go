...
func TestWorkerHTTPBrokerDoesNotRetainUntypedLedgerOrOrdinaryPayloads(t *testing.T) {
	...
	chatBroker := newWorkerHTTPBroker(RunManifest{Mode: ModeLive, Concurrency: 1, Seed: 1,
		TrackIDs: []TrackID{"joint"}, Target: ManifestTarget{EnvoyURL: chatServer.URL, Mixture: mixture}}, workerBrokerCredentials{})
